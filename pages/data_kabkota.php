                ...
                <tbody>
                  ...
                  <?php foreach($daftar_kab_kota as $row): ?>
                    <tr>
                      ...
                      <td><?php echo $row["pusat_pemerintahan"]; ?></td>
                      <td><?php echo $row["bupati_walikota"]; ?></td>
                      ...
                      <td style="text-align: center; white-space:nowrap;">
                        ...
                        <a href="pages/kabkota/proses_hapus_kabkota.php?id=<?=$row['id'];?>" class="btn btn-danger btn-sm" role="button" title="Hapus Data" onclick="return confirm('Apakah anda yakin?')"><i class="fas fa-trash"></i></a>
                      </td>
                    </tr>
        ...
        <div class="container">
          <div class="row">
            <div class="col-12 mb-2 text-center">
              ...
              if($url_peta_wilayah == null){
                echo "<img src='image/peta/Indonesia.svg' style='width: 400px;'/>";
              } else {
                echo "<img src='$url_peta_wilayah' style='width: 400px;'/>";
              }
              ?>
            </div>
            ...
            <div class="col-6 col-sm-6">
              <a href="image/logo/<?= $row["logo"]; ?>"><?= $row["kabupaten_kota"]; ?></a>
            </div>

            <div class="w-100 d-none d-md-block"></div>
            <div class="col-sm-5 col-6"><u>Deskripsi Singkat</u></div>
            <div class="col-sm-10"><p><?= $row["deskripsi"]; ?></p></div>
          </div>
        </div>
      </div>
    </div>
