    ...
    <div class="row">
      <div class="col-md-8">
        ...
        <div class="card card-primary">
          ...
          <!-- form start -->
          <form id="tambahData" method="post" action="pages/kabkota/proses_tambah_kabkota.php" enctype="multipart/form-data">
            <div class="card-body">

              <div class="form-group">
                <label for="kabupaten_kota">Kabupaten/Kota</label>
                <input type="text" name="kabupaten_kota" class="form-control" id="kabupaten_kota" placeholder="Masukan nama Kabupaten/Kota...">
              </div>
              ...
              <div class="form-group">
                ...
                <div class="input-group date" id="tanggal_berdiri" data-target-input="nearest">
                  <input type="text" class="form-control datetimepicker-input" data-target="#tanggal_berdiri" name="tanggal_berdiri" id="tanggal_berdiri"/>
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" name="deskripsi" id="deskripsi" rows="4" placeholder="Masukan beberapa teks deskripsi -> kabupaten/kota..."></textarea>
              </div>
